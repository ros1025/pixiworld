...
public class RoadModifyPreview : IDynamicPreviewSystem
{
    ...
    private bool expand;
    private Roads selectedRoad;


    public void StartPreview(List<Vector3> points, Roads road, PlacementSystem system, InputManager input, float width, float height)
    {
        this.system = system;
        this.input = input;
        this.width = width;
