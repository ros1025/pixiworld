...
public class ZoneSelectionPreview : IStaticPreviewSystem
{
    ...
    public void StartPreview(Vector3 gridPosition, float rotation, GameObject prefab, Vector2Int size, PlacementSystem system, InputManager input)
    {
        this.system = system;
        this.input = input;
