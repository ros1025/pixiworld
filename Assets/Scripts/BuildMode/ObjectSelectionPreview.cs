...
public class ObjectSelectionPreview : IStaticPreviewSystem
{
    ...
    public void StartPreview(Vector3 gridPosition, float rotation, GameObject prefab, Vector2Int size, Vector2 cursorOffset, List<MatData> materials, PlacementSystem system, InputManager input)
    {
        this.system = system;
        this.input = input;
